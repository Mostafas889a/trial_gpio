...
void main(void) {
    ...
    GPIOs_configure(11, GPIO_MODE_USER_STD_BIDIRECTIONAL);
    GPIOs_configure(12, GPIO_MODE_USER_STD_BIDIRECTIONAL);
    GPIOs_configure(13, GPIO_MODE_USER_STD_BIDIRECTIONAL);
    GPIOs_configure(14, GPIO_MODE_USER_STD_BIDIRECTIONAL);
    GPIOs_configure(15, GPIO_MODE_USER_STD_BIDIRECTIONAL);
    GPIOs_loadConfigs();
    ...
    uint32_t read_val = USER_readWord(GPIO0_BASE + GPIO_DATAI_OFFSET);
    ...
    USER_writeWord(0x55, GPIO0_BASE + GPIO_DATAO_OFFSET);
    vgpio_write_output(6);
    
    USER_writeWord(0x00, GPIO0_BASE + GPIO_DATAO_OFFSET);
